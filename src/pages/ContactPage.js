      ...
      <div className="wrapper-tablet">
        ...
        <div className="contactpage-s2-box">
          <div className="contactpage-s2-text">
            ...
            <p>
              Så kontakt Den Blå Bar ved indgangen - eller send os en mail hurtigst muligt på <br></br>
              <a href="mailto: kontakt@aarhusstreetfood.com">  kontakt@aarhusstreetfood.com.</a>
            </p>

            <h3>BORDBOOKING</h3>
            <p>
              Vi har bygget det lækreste nye område Grøn Stue med plads til 150
              siddende gæster. Her tager vi imod bordbestillinger, på minimum
              16 personer - alle ugens dage.
              Er I færre, finder I bare selv et par langborde i byens bedste
              Garage. Send din forspørgsel på booking til
              <br></br>
              <a href="mailto: booking@aarhusstreetfood.com">  booking@aarhusstreetfood.com.</a>
